              ...
              child: BottomButton(
                  ...
                  tap: () async {                     
                     ...
                     if (_birthdayController.text == '') {
                        setModalState(() {
                          _birthdayError = 'Ingresa tu fecha de nacimiento';
                          birthdayValid = false;
                        });
                     }  else {
                          final RegExp dayRegex = RegExp(r'^\d{1,2}/\d{1,2}/\d{4}$');
                          if (dayRegex.hasMatch(_birthdayController.text.toString())) {
                              setModalState(() {
                                _birthdayError = null;
                                birthdayValid = true;
                              });
                              ...
                              setModalState(() {
                                _birthdayError = 'Fecha no valida. Debe ser DD/MM/AAAA';
                                birthdayValid = false;
                              });                          
                          }
                     }
                     ...
                     if (_phoneController.text == '') {
                        setModalState(() {
                          ...
                          if (phoneRegex.hasMatch(_phoneController.text.toString())) {
                              setModalState(() {
                                _phoneError = null;
                                phoneValid = true;
                              });
                              ...
                              setModalState(() {
                                _phoneError = 'Formato de telefono no valido.';
                                phoneValid = false;
                              });                          
                          }
                     }
                     ...
                     if (_emailController.text == '') {
                        setModalState(() {
                          _emailError = 'Ingresa tu correo institucional.';
                          emailValid = false;
                        });
                     }  else {
                        final RegExp emailRegex = RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$');
                        if (emailRegex.hasMatch(_emailController.text.toString())) {
                            setModalState(() {
                              _emailError = null;
                              emailValid = true;
                            });
                            ...
                            setModalState(() {
                              _emailError = 'Formato de correo no valido.';
                              emailValid = false;
                            });                          
                        }                        
                     }
                     ...
                     if (_emailConfController.text == '') {
                        setModalState(() {
                          _emailConfError = 'Ingresa tu correo institucional.';
                          emailConfValid = false;
                        });
                     }  else {
                        if (_emailConfController.text == _emailController.text){
                            setModalState(() {
                     ...
                     if (_passwordController.text == '') {
                        ...
                        if (_passwordController.text.length < 6){
                            setModalState(() {
                               _passwordError = 'La contraseña debe tener almenos 6 caracteres.';
                               passwordValid = false;
                            });
                        } else {
                            setModalState(() {
                     ...
                     if (_passwordConfController.text == '') {
                        ...
                        if (_passwordConfController.text == _passwordController.text){
                            setModalState(() {
                            ...
                            setModalState(() {
                            _passwordConfError = 'La contraseña no coincide.';
                            passwordConfValid = false;
                            });
                        }
                    ...
                    if (nameValid && lastNameValid && birthdayValid && genderValid && phoneValid && emailValid && emailConfValid && passwordValid && passwordConfValid) {
                      DateTime _birthday =
                          dateFormat.parse(_birthdayController.text.toString());
                      String _outputBirth =
                      ...
                      if (extractdata['id'] > 0) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => HomeView(userInfo.id)),
                        );
                      }
                    }
                  })),
